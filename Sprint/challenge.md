...
Answer both of these questions (baseline ~5 sentences) here in text.
  1.  One of the most important part of code reviews in my opinion
  is to see the logic through which somebody else solves a problem, and then
  learn from that. When I review code, I also want to make sure how much
  it can be reused. I appreciate when people tell me how a function can be
  logistically simplified.
  2. As far as I understand it, containers could help by being able to run
  certain slightly-different programs at a whim on any of our computers,
  using a consistent Docker container. This would help us make sure that
  all requirements are met when running something, without actually having
  to install all those requirements on every individual machine.
